...
//                 <a
//                   href="/login"
//                   className="inline-block text-white bg-slate-500 hover:bg-slate-300 py-1 px-2 rounded focus:outline-none focus:ring-2 focus:ring-blue-300 text-sm"
//                 >
//                   Log In
//                 </a>
//               </>
...
//                 <path d="M4 19L20 19" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
//               </svg>
//             </button>
//           </div>
//         </div>
...
//             {id ? (
//               <>
//                 <a href={`/student/${id}/department`} className="block text-gray-700 py-2 px-4 hover:bg-gray-200">Department</a>
//                 <a href={`/student/${id}/compForm`} className="block text-gray-700 py-2 px-4 hover:bg-gray-200">Issue Item</a>
...
//                 <button
//                   onClick={handleLogout}
//                   className="block text-white bg-red-400 py-2 px-4 rounded hover:bg-red-500"
//                 >
//                   Log Out
//                 </button>
//               </>
...
//                 <a href="/achievement" className="block text-gray-700 py-2 px-4 hover:bg-gray-200">Achievements</a>
//                 <a href="/help" className="block text-gray-700 py-2 px-4 hover:bg-gray-200">Help</a>
//                 <a href="/register" className="block text-white bg-blue-600 py-2 px-4 rounded hover:bg-blue-700">
//                   Sign Up
//                 </a>
//                 <a href="/login" className="block text-white bg-slate-500 py-2 px-4 rounded hover:bg-slate-300">
//                   Log In
//                 </a>
//               </>
//             )}
...
//           {/* Logo */}
//           <div className="text-2xl font-bold text-blue-600 hover: cursor-pointer"><a href={ id?`/student/${id}`:'/'}>CLS</a></div>
...
//               // Show Log Out when the user is signed in
//               <>
...
//               </>
//             ) : (
//               // Show Sign Up and Log In when the user is not signed in
//               <>  
//                   <a href="#" className="text-gray-700 hover:text-blue-600">Achievements</a>
//                   <a href="#" className="text-gray-700 hover:text-blue-600">Help</a>
//                   <a href="/register" className="inline-block text-white bg-blue-600 hover:bg-blue-700 py-1 px-2 rounded focus:outline-none focus:ring-2 focus:ring-blue-300 text-sm">
