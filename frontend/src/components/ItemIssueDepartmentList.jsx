...
// import { useNavigate } from 'react-router-dom'; // Import this for navigation (if using React Router)
...
//       route: '/departments/electrical', // Replace with the actual route
//     },
//     {
//       id: 2,
//       name: 'ECE Department',
...
//             />
//             <h2 className="text-xl font-medium">{department.name}</h2>
//           </div>
//           <div
...
//             }`}
//           >
//             <p className="text-gray-700 text-base">{department.description}</p>
//             <button
