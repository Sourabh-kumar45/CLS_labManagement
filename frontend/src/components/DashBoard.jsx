    ...
    <>
      ...
      <div className="flex flex-col justify-center">
          ...
          <div className="flex flex-col bg-gray-100">
            <main className="p-6">
              <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {/* Card 1 */}
                  <div className="bg-white p-6 rounded-lg shadow-lg flex flex-col items-center transition-transform duration-300 hover:scale-105 hover:shadow-xl hover:bg-blue-50">
                    <h2 className="text-xl font-semibold text-blue-700 mb-2">Technologies</h2>
                  ...
                  {/* Card 3 */}
                  <div className="bg-white p-6 rounded-lg shadow-lg flex flex-col items-center transition-transform duration-300 hover:scale-105 hover:shadow-xl hover:bg-blue-50">
                    <h2 className="text-xl font-semibold text-blue-700 mb-2">Personalized</h2>
                    <p className="text-gray-700 text-center mb-4">
                      This platform is designed to provide a customized
                      experience, ensuring that students and teachers can
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a
            href="/register"
            className="relative inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-blue-600 transition duration-300 ease-out border-2 border-blue-500 rounded-full shadow-md group w-48"
          >
          ...
          <a
            href="/login"
            className="relative inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-green-700 transition duration-300 ease-out border-2 border-green-700 rounded-full shadow-md group w-48"
          >
            ...
            <span className="absolute flex items-center justify-center w-full h-full text-green-700 transition-all duration-300 transform group-hover:translate-x-full ease">
              Login
            </span>
